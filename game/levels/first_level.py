...
from game.levels.second_level import SecondLevel
...
class FirstLevel:
    def __init__(self):
        ...
        # Transfer INIT
        tiles_builder.add_row(232, 128, "down", 3, Transfer, level_class=SecondLevel)

        # Creating map of tiles
        self.map_of_tiles = tiles_builder.build()

        # Enemies INIT
        self.first_slime = Slime(180, 70, map_of_tiles=self.map_of_tiles)
        self.second_slime = Slime(180, 130, map_of_tiles=self.map_of_tiles)
        self.third_slime = Slime(180, 190, map_of_tiles=self.map_of_tiles)
    ...
    def update(self):
        ...
        self.third_slime.update(self.hero, chase_radius=80)
